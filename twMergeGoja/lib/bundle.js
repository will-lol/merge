var m = (function() {
  ...
  // tw-merge.js
  var tw_merge_exports = {};
  __export(tw_merge_exports, {
    createTailwindMerge: function() {
  ...
  function getDefaultConfig() {
    ...
    var getLengthWithEmptyAndArbitrary = function getLengthWithEmptyAndArbitrary2() {
  ...
  function mergeConfigs(baseConfig, _ref6) {
    var cacheSize = _ref6.cacheSize, prefix = _ref6.prefix, separator = _ref6.separator, _ref6$extend = _ref6.extend, extend = _ref6$extend === void 0 ? {} : _ref6$extend, _ref6$override = _ref6.override, override = _ref6$override === void 0 ? {} : _ref6$override;
  ...
  return __toCommonJS(tw_merge_exports);
})();
